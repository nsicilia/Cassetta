    ...
    var body: some View {
        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false){
                ...
                ZStack{
                    if inSearchMode {
                        UserListView(viewModel: viewModel, searchText: $searchText, isPopupBarPresented: $isPopupBarPresented, PlayingPost: $PlayingPost)
